...
(() => {
    if(conf.email == "" && conf.password == "" || conf.email == "" || conf.password  == ""){
      console.log("Non è stato possibile collegarsi all'account MEGA, assicurati di aver inserito la tua email e la tua password nel file di configurazione");
    }else{
